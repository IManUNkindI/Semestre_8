...
%			2. write the compessed/cleaned file in pofacets 3 format
clear
...
disp(['number of facets with zero area removed: ',num2str(ifct)])
...
facet=newfacet;
      ...
      [filename pathname]=uiputfile('*.mat','Name of compressed file',modelname);
      if filename~=0
